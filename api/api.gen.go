...
func (e TypeUnitType) Valid() bool {
	...
	case AcOutlet:
		return true
	case AcOutletSimplePowerMetering:
		return true
	case AvmButton:
		return true
	case AvmMeter:
	...
	case ColorBulb:
		return true
	case DimmableColorBulb:
		return true
	case DimmableLight:
		return true
	case DimmerSwitch:
		return true
	case DoorOpenCloseDetector:
		return true
	case FloodDetector:
		return true
	case GasDetector:
	...
	case SimpleDoorLock:
		return true
	case SimpleHumiditySensor:
		return true
	case SimpleLevelControllable:
		return true
	case SimpleLevelControllableSwitchable:
		return true
	case SimpleLight:
		return true
	case SimpleOnOffSwitchable:
		return true
	case SimpleTemperatureSensor:
		return true
	case Siren:
		return true
	case SmokeDetector:
		return true
	case SwitchableGroup:
		return true
	case ThermostatGroup:
		return true
	case UserInterface:
		return true
	case VibrationDetector:
		return true
	case WindowOpenCloseDetector:
		return true
	default:
		return false
	}
...
func (siw *ServerInterfaceWrapper) DeleteConfigurationDeviceByUID(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "UID", r.PathValue("UID"), &uid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
